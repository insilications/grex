...
Version  : 1.2.0
Release  : 1
URL      : file:///aot/build/clearlinux/packages/grex/grex-v1.2.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/grex/grex-v1.2.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: grex-bin = %{version}-%{release}
...
%package bin
Summary: bin components for the grex package.
Group: Binaries

%description bin
bin components for the grex package.
